! function() {
    ...
    Inline.prototype.loadButtonCSS = function() {
        ...
        var t, e = this;
        e.defaults.customButton ? (t = document.getElementById(e.defaults.customButton)).setAttribute("data-paystack", e.defaults.id) : ((t = document.createElement("button")).innerHTML = "<span class='paystack-top-blue'>Pay Securely with Giveasily</span><span class='paystack-body-image'> </span>", t.setAttribute("class", "paystack-trigger-btn"), t.setAttribute("data-paystack", e.defaults.id), sourceScript.parentNode.insertBefore(t, sourceScript.nextSibling)), t.addEventListener("click", function(t) {
        ...
        return e.mode = "popup", e.hasTLSFallback = null !== this.defaults.tlsFallback, e.metadata && "string" != typeof e.metadata && (e.metadata = JSON.stringify(e.metadata)), void 0 !== e.card && -1 < ["false", !1].indexOf(e.card) && (e.channels = ["bank"], delete e.card), void 0 !== e.bank && -1 < ["false", !1].indexOf(e.bank) && (e.channels = ["card"], delete e.bank), {
            old: t + "?" + serialize(e),
            new: config.newCheckoutUrl + "popup?params=" + serialize(e)
        }
    }, Inline.prototype.appendIframe = function(t) {
        var e = this;
        iframe = document.createElement("iframe"), iframe.setAttribute("frameBorder", "0"), iframe.setAttribute("allowtransparency", "true"), iframe.style.cssText = t.cssText, iframe.id = iframe.name = e.defaults.id, iframe.src = t.src, iframe.className = t.className, t.parent.appendChild(iframe), e.iframe = iframe, iframe.onload = function() {
            e.iframeLoaded = !0
        }
    ...
    var PaystackPop = {
        setup: function(t, e) {
            ...
            if (isValid(r)) return e ? (checkForParentForm(e), void(window[n] = new Inline(r, getParentForm(e)))) : new Inline(r, !1)
        }
    };
    window.PaystackPop = PaystackPop;
    var sourceScript = document.currentScript || (fa = document.getElementsByTagName("script"), fa[fa.length - 1]),
        fa;

    function fetchTimeout(n, r) {
    ...
    function cssLoad(t, e) {
        ...
        return l.setAttribute("id", r), l.setAttribute("rel", "stylesheet"), l.setAttribute("type", "text/css"), void 0 !== l.addEventListener ? (l.addEventListener("load", u, !1), l.addEventListener("error", d, !1)) : void 0 !== l.attachEvent && l.attachEvent("onload", function() {
            var t, e = document.styleSheets.length;
            try {
                for (; e--;)
                    if ((t = document.styleSheets[e]).id === r) return t.cssText, void u()
            } catch (t) {}
            s || d()
        }), PaystackPop.loadedScripts = PaystackPop.loadedScripts || {}, null != PaystackPop.loadedScripts[r] || (PaystackPop.loadedScripts[r] = !0, document.getElementsByTagName("head")[0].appendChild(l), l.setAttribute("href", t), n)
    }
...
function(t) {
    ...
    if (!t.fetch) {
        ...
        }, t.Headers = h, t.Request = w, t.Response = _, t.fetch = function(n, i) {
            return new Promise(function(r, t) {
                ...
                a.onload = function() {
                    var t, i, e = {
                        ...
                        headers: (t = a.getAllResponseHeaders() || "", i = new h, t.replace(/\r?\n[\t ]+/g, " ").split(/\r?\n/).forEach(function(t) {
                            var e = t.split(":"),
                                n = e.shift().trim();
                            if (n) {
                                var r = e.join(":").trim();
    ...
    function w(t, e) {
        ...
        if (this.credentials = e.credentials || this.credentials || "omit", !e.headers && this.headers || (this.headers = new h(e.headers)), this.method = (r = (n = e.method || this.method || "GET").toUpperCase(), -1 < u.indexOf(r) ? r : n), this.mode = e.mode || this.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && i) throw new TypeError("Body not allowed for GET or HEAD requests");
        this._initBody(i)
    }
